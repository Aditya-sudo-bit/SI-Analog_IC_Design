...
N 350 -300 380 -300 {lab=#net2}
N 280 30 280 70 {lab=GND}
N 520 -180 520 -160 {lab=#net2}
N 520 -100 520 -70 {lab=GND}
N 460 -300 460 -100 {lab=#net2}
N 380 -300 460 -300 {lab=#net2}
N 350 -220 460 -220 {lab=#net2}
N 280 -130 300 -130 {lab=vcm}
N 280 -130 280 -30 {lab=vcm}
N 300 -110 300 -70 {lab=#net1}
N 220 -110 300 -110 {lab=#net1}
N 460 -180 520 -180 {lab=#net2}
